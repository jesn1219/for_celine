...
class MyApp(QMainWindow):
    ...
    def initUI(self):
        ...
        # Mode ellipse
        mode_ellipse_action = QAction('Ellipse',self)
        mode_ellipse_action.triggered.connect(self.mode_ellipse) 
        ...
        draw_menu.addAction(mode_ellipse_action)
    ...
    def paintEvent(self, e):
        ...
        for ellipse in self.ellipse_list :
            ...
            end_x = ellipse[1].x()
            end_y = ellipse[1].y()
            canvas.drawEllipse(start_x, start_y, end_x - start_x, end_y - start_y)
    ...
    def mousePressEvent(self, e):
        ...
        if self.draw_type == 'rect' :
            self.rect_list.append([e.pos(),e.pos(),self.brush_color])
            
        # Ellipse
        if self.draw_type == 'ellipse' :
            self.ellipse_list.append([e.pos(),e.pos(),self.brush_color])
    ...
    def mouseMoveEvent(self, e):
        ...
        # 2_Rect :
            ...
            self.update()
        elif (e.buttons() & Qt.LeftButton) & self.drawing and self.draw_type == 'ellipse':
            self.last_point = e.pos()
            self.ellipse_list[-1][1] = e.pos()
    ...
    def mode_ellipse(self) :
        self.draw_type = 'ellipse'
